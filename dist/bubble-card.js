                        ...
                        <div class="module-toggles-container">
                          ...
                          <div class="module-toggles">
                            <button 
                              ...
                              @click=${()=>{(t=>{const n=t.target,o=n.configValue,r=n.checked;e._config.modules=Array.isArray(e._config.modules)?e._config.modules:[];const i=Ae(o,e.hass);r?(e._config.modules=e._config.modules.filter((e=>e!==`!${o}`)),i||e._config.modules.includes(o)||(e._config.modules=[...e._config.modules,o])):i?(e._config.modules.includes(`!${o}`)||(e._config.modules=[...e._config.modules,`!${o}`]),e._config.modules=e._config.modules.filter((e=>e!==o))):e._config.modules=e._config.modules.filter((e=>e!==o));const a=e._myModulesSortOrder||"default",l=!0===e._expandedPanelStates?.[o];"default"===a&&(e._recentlyToggledModuleId=o,l&&(e._expandedPanelStates=e._expandedPanelStates||{},e._expandedPanelStates[o]=!0),setTimeout((()=>{e._recentlyToggledModuleId=null,e.requestUpdate()}),2e3)),(0,s.rC)(e,"config-changed",{config:e._config}),e.requestUpdate(),"default"===a&&r&&requestAnimationFrame((()=>{requestAnimationFrame((()=>{const t=e.shadowRoot?.querySelector(`ha-expansion-panel[data-module-id="${o}"]`);if(t){l&&!t.expanded&&(t.expanded=!0);const e=t.getBoundingClientRect();e.top>=0&&e.bottom<=window.innerHeight||t.scrollIntoView({behavior:"smooth",block:"start"})}}))}))})({target:{checked:!h,configValue:t}})}}
                            >
